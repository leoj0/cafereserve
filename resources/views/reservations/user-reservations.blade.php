<x-layout>
    <x-horizontal-card class="bg-gray-950 p-6">
        ...
        <section class="mt-8">
            <h3 class="page_title">Past Bookings</h3>
                    ...
                    <div class="group bg-gray-800 border border-gray-800 rounded-lg overflow-hidden hover:border-blue-500/50 hover:bg-gray-900 transition-all duration-300">
                        <div class="p-6">
                            <div class="flex items-center justify-between mb-6">
                                ...
                                <a href="{{ route('reservations.edit', $reservation->reservation_id) }}" class="text-gray-400 hover:text-blue-400 transition-colors duration-300" title="Edit Reservation">
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center text-gray-300">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-medium text-gray-200">{{ $reservation->table ? $reservation->table->table_number : 'Table Not Found' }}</p>
                                    </div>
                                </div>
                ...
                @empty
                    <div class="col-span-full flex flex-col items-center justify-center p-12 bg-gray-900 backdrop-blur-sm rounded-lg border border-gray-800">
                        ...
                        <a href="{{ route('cafes.index') }}" class="mt-6 px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-500 transition-colors duration-300 flex items-center gap-2">
                            <i class="fas fa-search"></i> Browse Cafes
                        </a>
                    </div>
                @endforelse
            </div>
        ...
        <section class="mt-8">
            <h3 class="page_title">Future Bookings</h3>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="p-6">
                            ...
                            <div class="mt-6 pt-6 border-t border-gray-800">
                                <form action="{{ route('reservations.cancel', $reservation->reservation_id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="w-full px-4 py-2 bg-red-600 hover:bg-red-500 text-white rounded-lg transition-colors duration-300 flex items-center justify-center gap-2">
                ...
                @empty
                    <div class="col-span-full flex flex-col items-center justify-center p-12 bg-gray-900 backdrop-blur-sm rounded-lg border border-gray-800">
                        ...
                        <p class="text-gray-200 text-lg mb-2">No Future Reservations</p>
                        <p class="text-gray-400 text-center">Your future reservation history will appear here once you make a booking.</p>
                        <a href="{{ route('cafes.index') }}" class="mt-6 px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-500 transition-colors duration-300 flex items-center gap-2">
                            <i class="fas fa-search"></i> Browse Cafes
                        </a>
                    </div>
